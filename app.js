...
async function guardarPerfilRegistro(){
  ...
  const archivo = document.getElementById("inputFotoRegistro").files[0];
...
// PREVIEW REGISTRO
// ======================
document.getElementById("inputFotoRegistro").addEventListener("change", function(e){
...
// ======================
// SUBIDA FOTO EDITAR PERFIL
// ======================
document.getElementById("inputFotoEditar").addEventListener("change", async function(e){
